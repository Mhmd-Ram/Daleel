...
<head>
    ...
    <title>You are registered for {{ $event->name }}</title>
</head>
        ...
        <tr>
            <td style="padding:28px; background-color:#ffffff; border:1px solid #e7e5e4; border-top:0; border-radius:0 0 16px 16px;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; font-size:14px;">
                    <tr>
                        <td style="padding:10px 0; color:#78716c; width:110px;">Starts</td>
                        <td style="padding:10px 0; font-weight:600; color:#1c1917;">{{ $event->start_date_time->format('l, M j, Y \a\t g:i A') }}</td>
                    </tr>
                    <tr>
                        <td style="padding:10px 0; border-top:1px solid #f5f5f4; color:#78716c;">Ends</td>
                    ...
                    <tr>
                        <td style="padding:10px 0; border-top:1px solid #f5f5f4; color:#78716c;">Location</td>
                        <td style="padding:10px 0; border-top:1px solid #f5f5f4; font-weight:600; color:#1c1917;">{{ $event->location }}</td>
                    </tr>
                    <tr>
                        <td style="padding:10px 0; border-top:1px solid #f5f5f4; color:#78716c;">Ticket</td>
                ...
                <p style="margin:24px 0 0; font-size:13px; line-height:1.6; color:#78716c;">
                    Cannot make it? Cancel your registration any time from
                    <a href="{{ route('my-events') }}" style="color:#047857;">My events</a>.
                </p>
            </td>
        </tr>
    </table>
