...
@section('content')
    <div class="reveal mx-auto max-w-lg">
        ...
        <h1 class="text-2xl font-semibold tracking-tight text-stone-900">New category</h1>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="mt-8 space-y-5 rounded-2xl border border-stone-200 bg-white p-6">
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-emerald-700 active:scale-[0.98]">Create category</button>
