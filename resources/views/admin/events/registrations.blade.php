...
@section('content')
    ...
    <div class="reveal mb-8">
        <h1 class="text-2xl font-semibold tracking-tight text-stone-900">Registered attendees</h1>
    ...
    @if ($event->registeredUsers->isEmpty())
        <div class="rounded-xl border border-dashed border-stone-300 bg-white px-6 py-16 text-center">
            <p class="text-lg font-medium text-stone-900">No registrations yet</p>
            <p class="mt-1 text-stone-500">When users register for this event, they'll appear here.</p>
        </div>
    @else
