...
@section('content')
    <div class="reveal mx-auto max-w-md">
        <h1 class="text-2xl font-semibold tracking-tight text-stone-900">Admin sign in</h1>
        <p class="mt-1 text-sm text-stone-500">Staff access for managing events and categories.</p>
